...
import { generateStignoreContent } from "../../src/services/syncthing/stignore";
...
describe("Stignore Content Generation", () => {
    ...
    describe("OS-Specific Files", () => {
        ...
        it("should ignore Windows files", () => {
            expect(content).toContain("Thumbs.db");
            expect(content).toContain("desktop.ini");
            expect(content).toContain("$RECYCLE.BIN/");
        });

        it("should ignore Linux temp files", () => {
            expect(content).toContain("*~");
        });
    });

    // Environment / secrets patterns
    it("should ignore environment and secret files", () => {
